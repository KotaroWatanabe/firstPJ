...
# from.models import Friend,ANKENTBL,ANKENDTLTBL,ICHIRANTBL,USERTBL,HYOKATBL,KOUMOKUM
...
#     class Meta:
#         model = ANKENTBL
#         fields = ['ANKENID','ANKENNM','ANKENDTLID','REQUESTDATE','RECRUITDATE','USERID','STID']
